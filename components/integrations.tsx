  ...
  return (
    ...
    >
      <div className="wrap" style={{ textAlign: "center" }}>
        <div className="cap" style={{ color: "#4E6C6E" }}>
        ...
        <div style={{ fontSize: "13px", color: "#4E6C6E", marginTop: "20px" }}>
          Plus AWS, Microsoft Entra ID, Azure, Google Workspace, Ping, Doppler,
          Venafi and Active Directory.
        </div>
      </div>
    </section>
  );
